...
def make_schematic(mc_filename, schem_filename):
    ...
    for _ in range(10):
        schem.setBlock(
            tuple(pos), "minecraft:repeater[facing=north,locked=true,powered=false]"
        )
        pos[1] -= 2
    ...
    for i in range(16):
        ...
        for _ in range(10):
            schem.setBlock(
                tuple(pos), "minecraft:repeater[facing=south,locked=true,powered=false]"
            )
            pos[1] -= 2
    ...
    schem.setBlock(
        tuple(pos), "minecraft:repeater[facing=west,locked=true,powered=false]"
    )
    pos[2] -= 4
    schem.setBlock(
        tuple(pos), "minecraft:repeater[facing=west,locked=true,powered=false]"
    ...
    for pos in pos_list_north[:-3]:
        ...
        for _ in range(8):
            schem.setBlock(
                tuple(x), "minecraft:repeater[facing=north,locked=true,powered=false]"
            )
            x[1] -= 2
    ...
    for pos in pos_list_north:
        ...
        for _ in range(8):
            schem.setBlock(
                tuple(x), "minecraft:repeater[facing=south,locked=true,powered=false]"
            )
            x[1] -= 2
    ...
    for pos in pos_list_east:
        ...
        for _ in range(8):
            schem.setBlock(
                tuple(x), "minecraft:repeater[facing=east,locked=true,powered=false]"
            )
            x[1] -= 2
        ...
        for _ in range(8):
            schem.setBlock(
                tuple(x), "minecraft:repeater[facing=west,locked=true,powered=false]"
            )
            x[1] -= 2
