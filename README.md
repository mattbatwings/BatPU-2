...
schematic-r.py - A script to convert .mc files to .schem (worldedit schematic) files for the computer in [video series](https://www.youtube.com/playlist?list=PL5LiOvrbVo8nPTtdXAdSmDWzu85zzdgRT) Using //paste -a
